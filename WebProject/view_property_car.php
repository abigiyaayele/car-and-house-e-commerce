...
<head>
   ...
   <title>View Property for car</title>
...
<section class="view-property">
   ...
   <?php
      $select_properties = $conn->prepare("SELECT * FROM `car_property` WHERE id = ? ORDER BY date DESC LIMIT 1");
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-phone"></i><a href="tel:+251911121314"><?= $fetch_user['number']; ?></a></p>
      ...
      <div class="flex">
         <div class="box">
         <p><i>Type :</i><span><?= $fetch_property['type']; ?> </span></p>
         <p><i>Model :</i><span><?= $fetch_property['model']; ?> </span></p>
            <p><i>deposit amount : </i><span><span class="fas fa-indian-rupee-sign" style="margin-right: .5rem;"></span><?= $fetch_property['price']; ?></span></p>
            <p><i>status :</i><span><?= $fetch_property['status']; ?></span></p>
           
         </div>
         <div class="box">
          
            <p><i>car status :</i><span><?= $fetch_property['car_status']; ?> years</span></p>
            <p><i>loan :</i><span><?= $fetch_property['loan']; ?></span></p>
            <p><i>offer :</i><span><?= $fetch_property['offer']; ?></span></p>
         </div>
      </div>
   ...
   <?php
      ...
      echo '<p class="empty">property not found! <a href="carpost.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
   }
   ?>
